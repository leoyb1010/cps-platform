...
async function main() {
  ...
  for (const s of SETTLEMENTS) {
    const withSnap = fenObj({
      ...
      ...s,
      // agentPayout 已可能被历史 reversal 冲减；成交时点原始分润应还原为二者之和（比率对 ×100 不变，故用原始元值算）。
